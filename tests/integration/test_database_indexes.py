...
class TestMigrationMetadata:
    ...
    def test_transaction_migration_revision_id(self, transaction_migration):
        assert transaction_migration.revision == "20260408000001"

    def test_audit_log_migration_revision_id(self, audit_log_migration):
        assert audit_log_migration.revision == "20260408000002"

    def test_audit_log_depends_on_transaction_migration(self, audit_log_migration):
...
class TestTransactionIndexNames:
    ...
    def test_composite_index_user_status_defined(self, transaction_migration):
    ...
    def test_all_transaction_indexes_present(self, transaction_migration):
...
class TestDowngradeRemovesIndexes:
    ...
    def test_transaction_downgrade_removes_all_indexes(self, transaction_migration):
        src = self._downgrade_source(transaction_migration)
        for name in EXPECTED_TRANSACTION_INDEXES:
            assert name in src, f"downgrade() missing drop for: {name}"

    def test_audit_log_downgrade_removes_all_indexes(self, audit_log_migration):
...
class TestUpgradeDowngradeCallable:
    ...
    def test_transaction_upgrade_callable(self, transaction_migration):
        assert callable(transaction_migration.upgrade)

    def test_transaction_downgrade_callable(self, transaction_migration):
        assert callable(transaction_migration.downgrade)

    def test_audit_log_upgrade_callable(self, audit_log_migration):
        assert callable(audit_log_migration.upgrade)

    def test_audit_log_downgrade_callable(self, audit_log_migration):
