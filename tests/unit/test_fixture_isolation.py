...
class TestDatabaseIsolation:
    ...
    def test_user_from_previous_test_not_visible(self, db_session):
    ...
    def test_transaction_from_previous_test_not_visible(self, db_session):
...
class TestCacheIsolation:
    ...
    def test_cache_is_empty_after_reset(self, reset_cache_fixture):
    ...
    def test_reset_cache_fixture_clears_after_test(self, reset_cache_fixture):
...
class TestRateLimiterIsolation:
    ...
    def test_rate_limiter_write(self, reset_rate_limiter):
    ...
    def test_rate_limiter_is_empty_after_reset(self, reset_rate_limiter):
...
class TestFactoryFixtures:
    ...
    def test_make_user_creates_valid_user(self, db_session, make_user):
    ...
    def test_make_user_accepts_overrides(self, db_session, make_user):
    ...
    def test_make_user_creates_unique_users(self, db_session, make_user):
    ...
    def test_make_transaction_creates_valid_transaction(self, db_session, make_transaction):
    ...
    def test_make_transaction_accepts_overrides(self, db_session, make_transaction):
    ...
    def test_make_transaction_creates_unique_transactions(self, db_session, make_transaction):
    ...
    def test_make_transaction_linked_to_user(self, db_session, make_user, make_transaction):
    ...
    def test_make_user_password_is_hashed(self, db_session, make_user):
    ...
    def test_make_user_check_password(self, db_session, make_user):
